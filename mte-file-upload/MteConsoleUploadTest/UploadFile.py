...
class UploadFile:
    ...
    def handshake_with_server(self, client_id) -> ResponseModel:
        ...
        response.data.max_seed = encoder.get_drbgs_reseed_interval(encoder.get_drbg())
    ...
    def send(self, path, use_mte, encoder_state, decoder_state, client_id) -> ResponseModel:
        ...
        if use_mte:
            ...
            upload_response.data.current_seed = encoder.get_reseed_counter()
        ...
        if use_mte:
            ...
            # Return the current seed count.
            upload_response.data.current_seed = decoder.get_reseed_counter()
